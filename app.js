...
function buildAiRequest() {
  ...
  return {
    ...
    context: {
      ...
      keySessionSpacingRules: [
        "Полноценными тяжелыми беговыми стимулами считай VO2max, интервалы в усилии 3/5/10 км, пороговую или тяжелую темповую работу, тяжелые горки, гонку и длительную с быстрым блоком.",
        "Между двумя полноценными тяжелыми беговыми стимулами целевой интервал - не менее 72 часов: при двух работах сначала ищи расстановку, которая дает обе выполнить качественно. В календарном плане вторник-пятница или среда-суббота - обычный 72-часовой вариант, а среда-пятница - 48-часовое исключение.",
        "Интервал 48-71 час - исключение только для подготовленного спортсмена с низкой субъективной усталостью, устойчивой переносимостью подобных недель и конкретной целью плотного микроцикла. Объясни его в rationale и сократи объем хотя бы одного стимула.",
        "Меньше 48 часов между полноценными тяжелыми беговыми стимулами не планируй. Учитывай также тяжелые фактические тренировки из recentWorkoutsDetailed и уже выполненные дни планируемой недели.",
        "Легкая длительная полностью в Z1-Z2 без прогрессии и быстрого финиша не равна интенсивной работе, но учитывай ее длительность и TRIMP. Тяжелая работа + легкая длительная на следующий день допустимы у подготовленного спортсмена, если длительная остается действительно легкой.",
        "Если два стимула физиологически близки, например VO2max и интервалы в усилии 10 км, оценивай их общий качественный объем и не назначай максимальный объем обоих шаблонов в одной неделе.",
        "Перед ответом проверь интервалы между всеми тяжелыми фактическими и плановыми стимулами. Не выбирай 48 часов только потому, что это формально допустимо.",
      ],
      hardSafetyRules: [
        ...
        "Применяй context.keySessionSpacingRules ко всем фактическим и планируемым тяжелым беговым стимулам.",
...
function workoutTemplateLibrary() {
  return [
    ...
    },
    {
      ...
      constraints: "Целевой интервал до полноценной интервальной работы - не менее 72 часов; 48-71 час только как обоснованное исключение со снижением качественного объема.",
